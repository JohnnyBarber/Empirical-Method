...
**Based on the AIC and BIC, we find that E_Garch model with the order of (1,1) with studnet t distribution fits the conditional volatility of the daily log returns best.**
...
$\\$
$\\$
Reasons that betas are not the same across 5-year periods:
The industry is embracing innovation or revolution, which shape the business style of this industry. Also, the risk profile of this industry changes over time, which could lead to the change of beta.