...
\begin{align*}
\omega_1 &= 0.7460541 \\
\omega_2 and \omega_3 &= \sqrt{(0.6037606)^2 + (\pm 0.4191605)^2} \approx 0.7350 \\
\omega_4 and \omega_5 &= \sqrt{(-0.6622935)^2 + (\pm 0.2021894)^2} \approx 0.6925 \\
\omega_6 and \omega_7 &= \sqrt{(-0.4375012)^2 + (\pm 0.5084891)^2} \approx 0.6708 \\
\omega_8 and \omega_9 &= \sqrt{(0.2706054)^2 + (\pm 0.6636678)^2} \approx 0.7167 \\
\omega_{10} and \omega_{11} &= \sqrt{(-0.1399119)^2 + (\pm 0.6679610)^2} \approx 0.6825 \\
\end{align*} 
As all characteristic roots are less than one, we can conclude that the model is stationary.
